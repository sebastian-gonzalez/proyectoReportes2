...
<body class="hold-transition sidebar-mini sidebar-collapse">
    ...
    <div class="content-wrapper">
        ...
        <!-- Modal Evaluacion jurado  -->
        <div class="modal fade" id="modalevalua" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content" id="repetir">


                    <?php
                    include('../../controlador/docente/editar_pdf_jurado.php');
                    ?>
