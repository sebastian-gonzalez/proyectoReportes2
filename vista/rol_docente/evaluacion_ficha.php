        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <div class='row'>
                    <div class='col-lg-12'>
                        <div class='form-group'>
                            ...
                            <select class="form-select derechaubicacion" aria-label="Default select example">
                    ...
                    <div class='col-lg-12'>
                        <div class='form-group'>
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control derechaubicacion" placeholder="Comentario" aria-label="Recipient's username" aria-describedby="basic-addon2">
                ...
                <div class='row'>
                    <div class='col-lg-12'>
                        <div class='form-group'>
                        Se define claramente el impacto educativo, ingenieril y/o tecnológico                            <select class="form-select derechaubicacion" aria-label="Default select example">
                                <option selected>Calificacion</option>
                                <option value="1">E</option>
                                <option value="2">B</option>
                                <option value="3">D</option>
                ...
                <div class='row'>
                    ...
                    <a class='btn btn-info derechaubicacion'  href="inicio_docente.php">Evaluar</a>
                </div>
                <br/>
