                        ...
                        <div class='col-lg-12'>
                            <div class='form-group'>
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control derechaubicacion" placeholder="Evaluacion" name="d1" aria-label="Recipient's username" aria-describedby="basic-addon2" required>
                    ...
                    <div class='row'>
                        <div class='col-lg-12'>
                            <div class='form-group'>
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control derechaubicacion" placeholder="Evaluacion" name="d2" aria-label="Recipient's username" aria-describedby="basic-addon2" required>
                                    <span class="input-group-text" id="basic-addon2">evaluacion</span>
                                </div>
                    ...
                    <div class='row'>
                        <div class='col-lg-12'>
                            <div class='form-group'>
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control derechaubicacion" placeholder="Evaluacion" name="d3" aria-label="Recipient's username" aria-describedby="basic-addon2" required>
                                    <span class="input-group-text" id="basic-addon2">evaluacion</span>
                                </div>
