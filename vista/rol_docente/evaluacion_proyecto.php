        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                    ...
                    <div class='col-lg-12'>
                        <div class='form-group'>
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control derechaubicacion" placeholder="Evaluacion" aria-label="Recipient's username" aria-describedby="basic-addon2">
                ...
                <div class='row'>
                    <div class='col-lg-12'>
                        <div class='form-group'>
                        B.3 El marco referencial fue sufucuente y apropiado para aplicar al proyecto
                            <div class="input-group mb-3">
                                <input type="text" class="form-control derechaubicacion" placeholder="Evaluacion" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                <span class="input-group-text" id="basic-addon2">evaluacion</span>
                            </div>
                ...
                <section>
                    <h4>D. SUSTENTACION DEL PROYECTO (VALORACION 15%):</h4>
                </section>
                <hr/>
