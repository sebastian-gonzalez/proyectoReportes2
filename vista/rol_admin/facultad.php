...
<body class="hold-transition sidebar-mini sidebar-collapse">
	...
	<div class="wrapper">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="table-responsive">
								<table id="tablaFacultades" class="table table-striped table-bordered table-condensed" style="width:100%">
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group">
												<label for="" class="col-form-label">Nombre Facultad:</label>
												<input type="text" class="form-control" id="nombre_facultad" required>
											</div>
										</div>
									</div>
		...
		<script type="text/javascript" src="../../controlador/admin/js/facultad.js"></script>
		<!-- jQuery -->
