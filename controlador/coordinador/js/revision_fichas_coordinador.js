$(document).ready(function () {
    ...
    tablaFichas = $("#tablaFichas").DataTable({
      ...
      columns: [
        ...
        {
          defaultContent:
            "<div class='text-center'><div class='btn-group'><button class='btn btn-primary btn-sm btnEvaluador margin-boton'  tooltip-dir='top' title='Agregar Evaluador'><i class='material-icons'>person_add</i></button><button class='btn btn-primary btn-sm btnEditar margin-boton'  tooltip-dir='top' title='Integrantes'><i class='material-icons'>groups</i></button><button class='btn btn-primary btn-sm btnRevision1'  tooltip-dir='top' title='Ver mas'><i class='material-icons'>control_point</i></button></div></div>",
        },
      ],
      responsive:true,
    });
