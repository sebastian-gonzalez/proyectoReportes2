...
if (isset($_POST['add_evaluador'])) {
     ...
     foreach ($_POST['id_lista_usuario_ev'] as $key => $value) {
          ...
          $consulta_validacion = "SELECT * FROM lista_ficha WHERE id_lista_ficha =$id_lista_ficha AND (id_lista_usuario=$id_lista_usuario AND id_rol_ficha = 2 AND lista_ficha.activo is null)";
          ...
          if ($resultado_vali->fetchColumn() > 0) {
               ...
               "<script> swal({
                   ...
                   location.href='../../vista/rol_coordinador/revision_fichas_coordinador.php';
                   }
                );
                ;</script>";
          } else {
