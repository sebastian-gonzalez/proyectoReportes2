$(document).ready(function () {
    ...
    tablaFichas = $("#tablaFichas").DataTable({
      ajax: {
        url: "../../controlador/docente/crud_fichas_director.php",
      ...
      columns: [
        ...
        {
          defaultContent:
            "<div class='text-center'><div class='btn-group'><button class='btn btn-primary btn-sm btnMostrar_P'  tooltip-dir='top' title='Integrantes'><i class='material-icons'>groups</i></button><button class='btn btn-primary btn-sm btnRevision'  tooltip-dir='top' title='PDF'><i class='material-icons'>picture_as_pdf</i></button></div></div>",
