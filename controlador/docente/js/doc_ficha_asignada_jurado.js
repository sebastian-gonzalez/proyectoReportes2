$(document).ready(function () {
    ...
    tablaFichas = $("#tablaFichas").DataTable({
      ajax: {
        url: "../../controlador/docente/crud_fichas_jurado.php",
      ...
      columns: [
        ...
        {
          defaultContent:
            "<div class='text-center'><div class='btn-group'><button class='btn btn-primary btn-sm btnRevisionevaluacion margin-boton'  tooltip-dir='top' title='Editar'><i class='material-icons'>edit</i></button><button class='btn btn-primary btn-sm btnMostrar_P margin-boton'  tooltip-dir='top' title='Integrantes'><i class='material-icons'>groups</i></button><button class='btn btn-primary btn-sm btnRevision'  tooltip-dir='top' title='Ver mas'><i class='material-icons'>control_point</i></button></div></div>",
        },
      ],
    });
...
$(document).on("click", ".btnEditar", function () {
  ...
  $("#modalevalua").modal("hide");
   ...
   $(document).on("click", ".btnRevisionevaluacion", function () {
    fila = $(this);
    id_ficha = parseInt($(this).closest("tr").find("td:eq(0)").text());
    opcion = 3; //eliminar
    location.href = "evaluacion_proyecto.php?ficha=" + id_ficha + " ";
  });
